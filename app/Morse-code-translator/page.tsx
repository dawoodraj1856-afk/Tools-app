  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-semibold mb-2">Morse Code Translator</h1>
        <p className="text-sm text-gray-500 mb-6">
          Type text to translate it into Morse code. Copy the result easily.
        </p>
        ...
        >
          {morse ? (
            <>
              <p className="text-sm font-medium">{morse}</p>
              <button
            ...
            <p className="text-sm text-gray-500">
              Start typing to see the Morse code.
            </p>
          )}
        </div>
      </div>
